...
namespace config {
    ...
    public:
         ...
         */
        explicit BasicConfigValue(const allocator_type& alloc)
        ...
        [[nodiscard]] ConfigValueKind kind() const noexcept {
            ...
            case 0:  return ConfigValueKind::Null;
            case 1:  return ConfigValueKind::Boolean;
            case 2:  return ConfigValueKind::Integer;
            case 3:  return ConfigValueKind::Floating;
            case 4:  return ConfigValueKind::String;
            case 5:  return ConfigValueKind::Array;
            case 6:  return ConfigValueKind::Object;
            default: return ConfigValueKind::Null;
            }
        }

        [[nodiscard]] bool is_null()    const noexcept { return kind() == ConfigValueKind::Null; }
        [[nodiscard]] bool is_bool()    const noexcept { return kind() == ConfigValueKind::Boolean; }
        [[nodiscard]] bool is_integer() const noexcept { return kind() == ConfigValueKind::Integer; }
        [[nodiscard]] bool is_floating() const noexcept { return kind() == ConfigValueKind::Floating; }
        [[nodiscard]] bool is_string()  const noexcept { return kind() == ConfigValueKind::String; }
        [[nodiscard]] bool is_array()   const noexcept { return kind() == ConfigValueKind::Array; }
        [[nodiscard]] bool is_object()  const noexcept { return kind() == ConfigValueKind::Object; }
    ...
    private:
        ...
        static typename Object::iterator
        find_in_object(Object& obj, std::string_view key) {
            return std::find_if(
                obj.begin(), obj.end(),
                [key](const KeyValue& kv) {
                    return kv.first == key;
                }
            );
        }
        ...
        static typename Object::const_iterator
        find_in_object(const Object& obj, std::string_view key) {
            return std::find_if(
                obj.begin(), obj.end(),
                [key](const KeyValue& kv) {
                    return kv.first == key;
